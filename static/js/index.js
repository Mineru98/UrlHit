...
if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
    $('body').append(`<style>
        ...
        <li>
            <a class="active" style="padding-top:8px;padding-bottom:8px;padding-left:16px;padding-right:0px;height:48px;" href="/"><img src="static/imgs/punch.png" width="32"></a>
        </li>
<li>
    ...
    </style><div class="ui overlay visible left vertical inverted sidebar menu default">
        <div class="menu top">
